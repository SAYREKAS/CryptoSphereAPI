...
class TestReadAllUsers:
    ...
    @pytest.mark.asyncio
    async def test_read_all_users(self, session):
...
class TestReadUserByUsername:
    ...
    @pytest.mark.asyncio
    async def test_read_user_by_username(self, session):
    ...
    @pytest.mark.asyncio
    async def test_read_user_by_username_not_found(self, session):
...
class TestDeleteUserByUsername:
    ...
    @pytest.mark.asyncio
    async def test_delete_user_by_username(self, session):
    ...
    @pytest.mark.asyncio
    async def test_delete_user_by_username_not_found(self, session):
